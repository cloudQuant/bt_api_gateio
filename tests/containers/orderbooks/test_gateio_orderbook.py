...
class TestGateioOrderBookData:
    """Tests for GateioOrderBookData."""

    def test_init(self):
        """Test initialization."""
        orderbook = GateioOrderBookData({}, symbol_name="BTC_USDT", asset_type="SPOT")

        assert orderbook.exchange_name == "GATEIO"
