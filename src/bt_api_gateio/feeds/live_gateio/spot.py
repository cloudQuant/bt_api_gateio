...
class GateioRequestDataSpot(GateioRequestData):
    ...
    def _get_ticker(self, symbol, extra_data=None, **kwargs) -> Any:
        ...
        extra_data = update_extra_data(
            ...
            normalize_function=GateioRequestDataSpot._get_ticker_normalize_function,
        )
    ...
    def _get_depth(self, symbol, limit=20, extra_data=None, **kwargs) -> Any:
        ...
        extra_data = update_extra_data(
            ...
            exchange_name=self.exchange_name,
            asset_type=self.asset_type,
            normalize_function=GateioRequestDataSpot._get_depth_normalize_function,
        )
        return path, params, extra_data
    ...
    def _get_kline(self, symbol, period="1m", limit=100, extra_data=None, **kwargs) -> Any:
        ...
        extra_data = update_extra_data(
            ...
            exchange_name=self.exchange_name,
            asset_type=self.asset_type,
            normalize_function=GateioRequestDataSpot._get_kline_normalize_function,
        )
        return path, params, extra_data
    ...
    def _get_balance(self, extra_data=None, **kwargs) -> Any:
        ...
        extra_data = update_extra_data(
            ...
            exchange_name=self.exchange_name,
            asset_type=self.asset_type,
            normalize_function=GateioRequestDataSpot._get_balance_normalize_function,
        )
        return path, params, extra_data
    ...
    def _make_order(
        ...
        **kwargs,
        ...
        extra_data = update_extra_data(
            ...
            exchange_name=self.exchange_name,
            asset_type=self.asset_type,
            normalize_function=GateioRequestDataSpot._make_order_normalize_function,
        )
    ...
    def _query_order(
        ...
        extra_data = update_extra_data(
            ...
            exchange_name=self.exchange_name,
            asset_type=self.asset_type,
            normalize_function=GateioRequestDataSpot._query_order_normalize_function,
        )
        return path, params, extra_data
